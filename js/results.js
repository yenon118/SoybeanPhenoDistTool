		...
		for (let i = 0; i < result_array.length; i++) {
			...
			if (!phenotype_array.includes(current_phenotype)) {
				...
				for (let i = 0; i < header_array.length; i++) {
					...
					header_th_tag.setAttribute("style", "border:1px solid black; min-width:80px; height:18.5px;");
			...
			for (let j = 0; j < header_array.length; j++) {
				...
				detail_td_tag.setAttribute("style", "border:1px solid black; min-width:80px; height:18.5px;");
