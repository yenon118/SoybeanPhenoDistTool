...
function constructMetadataTable(res, dataset, key, gene, chromosome, position, genotype, genotypeDescription) {
...
function queryMetadataByImprovementStatusAndGenotypeCombination(dataset, key, gene, chromosome, position, genotype, genotypeDescription) {
    $.ajax({
        ...
        success: function (response) {
            ...
            var metadata_table = constructMetadataTable(res, dataset, key, gene, chromosome, position, genotype, genotypeDescription);
...
function queryAllCountsByGeneChromosomePositions(dataset, gene, chromosome) {

    if (dataset && gene) {
        $.ajax({
            url: './php/queryAllCountsByGeneChromosomePositions.php',
            type: 'GET',
            contentType: 'application/json',
            data: {
                Dataset: dataset,
...
function queryAllByGeneChromosomePositions(dataset, gene, chromosome) {

    if (dataset && gene) {
        $.ajax({
            url: './php/queryAllByGeneChromosomePositions.php',
            type: 'GET',
            contentType: 'application/json',
            data: {
                Dataset: dataset,
